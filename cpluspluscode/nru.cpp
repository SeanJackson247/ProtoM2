...
void NRU::execute(int argsAddress){
    ...
    if(ErrorRegistry::errorCount==0){
        if(this->p->heap->data->getByte(argsAddress)==ByteCodeInstruction::TypeArgsListType){
            ...
            //this->debuggerOut("Executing Native, first Address:"+QString::number(firstArgAddress),true);
            if(this->p->heap->data->getByte(firstArgAddress)==ByteCodeInstruction::TypeRunTimeStringType){
                ...
                if(QString::compare(firstArgString,"sys.out")==0 || QString::compare(firstArgString,"app.debug")==0){
                    //this->debuggerOut("sys.out or app.debug call...",true);
                    bool isDebug=false;
                    if(QString::compare(firstArgString,"app.debug")==0){
                        isDebug=true;
                    }
                    //this->debuggerOut(QString::number(argumentCount)+" arguments",true);
                    int i=1;
                    while(i<argumentCount){
                        ...
                        //this->debuggerOut("Arguments Address:"+QString::number(argAddress),true);
                        if(argAddress==Architecture::NULLLocation){
                            if(isDebug){
                                this->p->nativeStore->resolve(NativeStore::DebugAddress,{"NULL"});
                            }
                            else{
                            ...
                            if(isDebug){
                                this->p->nativeStore->resolve(NativeStore::DebugAddress,{"unset"});
                            }
                            else{
                            ...
                            if(isDebug){
                                this->p->nativeStore->resolve(NativeStore::DebugAddress,{"true"});
                            }
                            else{
                            ...
                            if(isDebug){
                                this->p->nativeStore->resolve(NativeStore::DebugAddress,{"false"});
                            }
                            else{
                            ...
                            if(isDebug){
                                this->p->nativeStore->resolve(NativeStore::DebugAddress,{"[RPN]"});
                            }
                            else{
                            ...
                            if(isDebug==true){
                                //this->debuggerOut(QString::number(this->p->heap->decodeRawIntFrom(argAddress+Architecture::TypeRunTimeIntegerGutter)),true);
                            }
                            else{
                            ...
                            if(isDebug==true){
                                //this->debuggerOut(QString::number(this->p->heap->decodeRawFloatFrom(argAddress+Architecture::TypeRunTimeFloatGutter),'G',5),true);
                            }
                            else{
                        ...
                        else if(this->p->heap->data->getByte(argAddress)==ByteCodeInstruction::TypeRunTimeStringType){
                            if(isDebug){
                                //this->debuggerOut(this->p->heap->decodeStringFrom(argAddress),true);
                            }
                            else{
                            ...
                            if(isDebug){
                                this->p->nativeStore->resolve(NativeStore::DebugAddress,{objectString});
                            }
                            else{
                            ...
                            if(isDebug){
                                this->p->nativeStore->resolve(NativeStore::DebugAddress,{"[CONSTANT-OBJECT]"});
                            }
                            else{
                            ...
                            if(isDebug){
                                this->p->nativeStore->resolve(NativeStore::DebugAddress,{"[PROPERTY-KEY]"});
                            }
                            else{
                            ...
                            if(typeBit==ByteCodeInstruction::TypeRunTimeIntegerType){
                               if(isDebug==true){
                                   //this->debuggerOut(QString::number(this->p->heap->decodeRawIntFrom(propAddress+Architecture::TypeRunTimeIntegerGutter)),true);
                               }else{
                        ...
                        else if(this->p->heap->data->getByte(argAddress)==ByteCodeInstruction::TypeArrayType){
                            QString arrayString = this->p->heap->arrayToString(argAddress);
                            if(isDebug){
                                this->p->nativeStore->resolve(NativeStore::DebugAddress,{arrayString});
                            }
                            else{
                            ...
                            while(i<size){
                                ...
                                else if(this->p->heap->data->getByte(argaddr)==ByteCodeInstruction::TypeArrayType){
                                    argList+="ARRAY";
                                }
                    ...
                    if(this->p->heap->data->getByte(arrayaddr)==ByteCodeInstruction::TypeArrayType){
                    ...
                    if(cType==ByteCodeInstruction::TypeLambdaType && tType==ByteCodeInstruction::TypeRunTimeIntegerType){
                        int eventAddress = this->p->heap->decodeRawIntFrom(Architecture::EventStackAddress+1);
                        if(eventAddress!=Architecture::NULLLocation && eventAddress!=Architecture::UnsetLocation){
                            ...
                            this->p->heap->appendToArray(this->p->heap->decodeRawIntFrom(Architecture::EventStackAddress+1),eventAddress);
                        }
                        else{
                            ...
                            this->p->heap->data->setByte(Architecture::EventStackAddress+1,_newEventListAddress->getByte(0));
                            this->p->heap->data->setByte(Architecture::EventStackAddress+2,_newEventListAddress->getByte(1));
                            this->p->heap->data->setByte(Architecture::EventStackAddress+3,_newEventListAddress->getByte(2));
                            this->p->heap->data->setByte(Architecture::EventStackAddress+4,_newEventListAddress->getByte(3));
                        }
                    }
                    else{
 ...
 //                   argAddress = this->p->heap->decodeRawIntFrom(argAddress);
                    if(this->p->heap->data->getByte(secondArgAddress)==ByteCodeInstruction::TypeArrayType){
  //                      int i=2;
    //                    while(i<argumentCount){
                            ...
                            else if(this->p->heap->data->getByte(secondArgAddress)!=ByteCodeInstruction::TypeArrayType){
      ...
      //                  }
                    ...
                    if(this->p->heap->data->getByte(thirdArgAddress)==ByteCodeInstruction::TypeArrayType){
                    ...
                    else if(type==ByteCodeInstruction::TypeArrayType){
                        PByteArray* randomInt = new PByteArray();
...
//                    customReturn = true;
                    ...
                    if(oldArgsAddress==Architecture::NULLLocation || oldArgsAddress==Architecture::UnsetLocation){
                        ...
                        randomInt->setByte(0,ByteCodeInstruction::TypeArrayType);
                        int returnAddress = this->p->heap->data->size();
                        this->p->heap->copyToNew(randomInt,randomInt->size());
                        this->p->heap->setRETBuffer(returnAddress);
                    }
                    ...
                    if(this->p->heap->data->getByte(secondArgAddress)!=ByteCodeInstruction::TypeLambdaType){
                        ...
                        fourthArgAddress = this->p->heap->decodeRawIntFrom(fourthArgAddress);
                        if(this->p->heap->data->getByte(fourthArgAddress)==ByteCodeInstruction::TypeArrayType){
                            customReturn = true;
                            PByteArray* rpnStore = new PByteArray();
                            rpnStore->resize(Architecture::SIZE_OF_INITIAL_HEAP_STORE - Architecture::RPNAddress);
                            int i=0;
                    ...
                    secondArgAddress = this->p->heap->decodeRawIntFrom(secondArgAddress);
                    if(this->p->heap->data->getByte(secondArgAddress)!=ByteCodeInstruction::TypeRunTimeStringType){
                        ErrorRegistry::logError("Error - native('Module.load') expects first argument to be a string.");
                    }
                    else{
                        QString secondArgString = this->p->heap->decodeStringFrom(secondArgAddress);
                        ...
                        if(QString::compare(extension,"proto")==0){
                            ...
                            QObject::connect(compiler,SIGNAL(exportToInclusion(QString,QVector<Line*>)),compiler,SLOT(finalCompilation(QString,QVector<Line*>)));
                            ...
                            if(this->p->heap->data->getByte(callbackAddress)==ByteCodeInstruction::TypeLambdaType){
                                int eventListAddress = this->p->heap->decodeRawIntFrom(Architecture::EventStackAddress+1);
                    ...
                    if(this->p->parent>=0){
                        ...
                        if(this->p->parent<Interpreter::runtimeInstances.size()){
                            ...
                            int eventStackAddress = runtimeInstance->heap->decodeRawIntFrom(Architecture::EventStackAddress+1);
                    ...
                    else if(this->p->heap->data->getByte(dataAddress)!=ByteCodeInstruction::TypeRunTimeStringType){
                        ErrorRegistry::logError("Error - native('File.write') expects third argument to be a string.");
                    }
                    else{
                        QString secondArgString = this->p->heap->decodeStringFrom(secondArgAddress);
                        auto parts = secondArgString.split(".");
