...
PByteArray* Token2::compile(){
    ...
    if(this->type==TypeOperator || this->isOperator()==true){
        ...
        if(QString::compare(this->_string,"$")==0){
            ...
            res->setNum(Architecture::RPNAddress+(4*(this->data-1)));
            res->resize(4);
        }
...
/*    else if(this->type==Token::TypeLineNumberSetType || this->type==Token::TypePrimitiveAddress || this->type==Token::TypeComplexAddress){
 ...
 /*   else if(this->type==Token2::TypeRPNMarker){
    ...
    else if(this->type==Token2::TypeArrayInitMarker){
        //res->setNum(Architecture::RPNAddress+(4*this->idata));
...
/*    else if(this->type==Token2::TypeOperator){
        qDebug()<<"Compiling string to address:"<<this->address;
        res->setNum(this->address);
    }*/
    else if(this->type==Token2::TypeCode){
